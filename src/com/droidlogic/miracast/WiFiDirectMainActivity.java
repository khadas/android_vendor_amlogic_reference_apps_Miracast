...
public class WiFiDirectMainActivity extends Activity implements
    ...
    public void onResume() {
        ...
        mClick2Settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //WiFiDirectMainActivity.this.startActivity(new Intent(ACTION_NETWORK_SETTINGS));
    ...
    public void onPeersAvailable(WifiP2pDeviceList devicelist) {
        ...
        for (int i = 0; i < peers.size(); i++) {
            ...
            if (DEBUG) {
                Log.d(TAG, "peerDevice:" + peers.get(i).deviceName
                        + ", status:" + peers.get(i).status
    ...
    public void setDevice(WifiP2pDevice device) {
        ...
        Log.d(TAG, "====setDevice.mDevice.status: " + mDevice.status);
